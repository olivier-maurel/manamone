...
use App\Repository\App\EnvelopeRepository;
...
class Envelope
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Project::class, inversedBy="envelopes")
     */
    private $project;

    /**
     * @ORM\ManyToOne(targetEntity=Account::class, inversedBy="envelopes")
     */
    private $account;
